...
void fn_c() {
  SimpleStringOwner c{ "cccccccccc" };    // This initialization throws an error due to lack of memory. Call stack begins
  // unwinding and SimpleStringOwners 'b' and 'a' are destroyed before the exception is handled
}
...
int main() {
  ...
  */
  ...
  try {
    ...
    fn_b();
    SimpleStringOwner d{ "d" };     // this never constructs due to error thrown
